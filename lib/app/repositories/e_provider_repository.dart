...
class EProviderRepository {
  ...
  Future<List<AvailabilityHour>> getAvailabilityByProviderId(
      String providerid) {
    return _laravelApiClient.getAvailabilityByProviderId(providerid);
  }

  Future<bool> addAvailibility(data) {
    return _laravelApiClient.addAvailibility(data);
  }

  Future<bool> deleteAvailabilityByProviderId(id) {
    return _laravelApiClient.deleteAvailabilityByProviderId(id);
  }
}
