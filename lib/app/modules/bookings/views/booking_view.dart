...
class BookingView extends GetView<BookingController> {
  ...
  Widget build(BuildContext context) {
    ...
    print(controller.booking.value.expiringAt.isNotEmpty);
                ...
                SliverToBoxAdapter(
                  child: Column(
                    ...
                    children: [
                      ...
                      BookingTilWidget(
                        title:
                            Text("Pricing".tr, style: Get.textTheme.subtitle2),
                        content: Column(
                          children: [
                            BookingRowWidget(
                                description:
