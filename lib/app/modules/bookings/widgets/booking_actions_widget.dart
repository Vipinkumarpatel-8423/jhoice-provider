    ...
    return Obx(() {
      return Container(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.end, children: [
          if (_booking.value.status.order == Get.find<GlobalService>().global.value.received && !_booking.value.cancel)
            Expanded(
          ...
          if (_booking.value.status.order == Get.find<GlobalService>().global.value.accepted && !_booking.value.cancel )
            Expanded(
                child: BlockButtonWidget(
                    text: Stack(
                      alignment: AlignmentDirectional.centerEnd,
          ...
          if (_booking.value.status.order == Get.find<GlobalService>().global.value.onTheWay && !_booking.value.cancel)
            Expanded(
              child: BlockButtonWidget(
                  text: Stack(
                    alignment: AlignmentDirectional.centerEnd,
