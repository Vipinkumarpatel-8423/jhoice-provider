                      ...
                      _eService.terms.isNotEmpty
                          ? EServiceTilWidget(
                              title: Text("Terms of Service",
                                  style: Get.textTheme.subtitle2),
                              content: buildTermsOfService(_eService, context),
                            )
                          : Container(),
        ...
        ? Container(
            ...
            child: Row(
              children: [
                ...
                Text(
                    _eService.duration.contains(":")
                        ? _eService.duration + ' h'
                        : _eService.duration.contains(" ")
                            ? _eService.duration.split(" ")[0] +
                                ' h ' +
                                _eService.duration.split(" ")[1] +
                                ' d ' +
                                _eService.duration.split(" ")[2] +
                                ' m ' +
                                _eService.duration.split(" ")[3] +
                                ' y '
                            : (_eService.priceUnit == 'daily'
                                ? _eService.duration + ' d'
                                : _eService.priceUnit == 'monthly'
                                    ? _eService.duration + ' m'
                                    : _eService.duration + ' y'),
