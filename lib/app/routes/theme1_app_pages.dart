...
import 'package:home_services_provider/app/modules/availabiliity/bindings/availibility_bindings.dart';
import 'package:home_services_provider/app/modules/availabiliity/views/availibility_form_view.dart';
...
class Theme1AppPages {
  ...
  static final routes = [
    ...
    GetPage(
        ...
        transition: Transition.downToUp),
    GetPage(
        name: Routes.COUPON_FORM,
        page: () => CustomCouponFormView(),
        binding: CouponsBinding()),
    GetPage(
    ...
    GetPage(
        name: Routes.AVAILIBILITY,
        page: () => AvailibilityFormView(),
        binding: AvailibilityBinding()),
  ];
}
